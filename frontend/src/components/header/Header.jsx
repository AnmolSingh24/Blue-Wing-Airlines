...
import logo from "../../assets/images/BlueWingAirwaysLogo.png"
...
const Header = () => {
    return (
        <>
            <div className='h-12 flex items-center justify-between ml-10 text-blue-500'>
                <img src={logo} alt="logo" className='w-12' />
                <p className='-ml-[16rem]'>Blue Wing Airways</p>
